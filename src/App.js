...
import Practice24 from 'practices/Practice24';
import Practice25 from 'practices/Practice25';
...
const App = () => {
   return (
      <Switch>
         ...
         <Route path='/practice/24' component={Practice24} />
         <Route path='/practice/25' component={Practice25} />
      </Switch>
   );
};
